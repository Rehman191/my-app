...
const FOOTER_LINKS = {
  "Quick Links": [
    ...
    { label: "Logistics Integration", href: "#logistics" },
    { label: "Export Quote", href: "#export-check" },
...
const CONTACT: ContactItem[] = [
  { icon: "M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z", text: "1st Floor, Plot 193, Street 1, I-10/3 Industrial Area, Islamabad", href: "https://maps.google.com/?q=Plot+193,+Street+1,+I-10/3+Industrial+Area,+Islamabad,+Pakistan", target: "_blank", rel: "noopener noreferrer" },
  { icon: "M6.6 10.8c1.4 2.8 3.8 5.1 6.6 6.6l2.2-2.2c.3-.3.7-.4 1-.2 1.1.4 2.3.6 3.6.6.6 0 1 .4 1 1V20c0 .6-.4 1-1 1-9.4 0-17-7.6-17-17 0-.6.4-1 1-1h3.5c.6 0 1 .4 1 1 0 1.3.2 2.5.6 3.6.1.3 0 .7-.2 1L6.6 10.8z", text: "+92 (51) 111-111-265", href: "tel:+9251111111265" },
  { icon: "M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.435 9.884-9.884 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z", text: "+92 (300) 850-1545 (WhatsApp)", href: "https://wa.me/923008501545", target: "_blank", rel: "noopener noreferrer" },
  { icon: "M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z", text: "info@amlexports.com", href: "mailto:info@amlexports.com" },
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer__body">
        <div className="footer__container footer__grid">
          ...
          <div className="footer__col">
            <h4 className="footer__col-title">Sister Concern</h4>
            <div className="footer__sister-concern-box">
              <h5 className="footer__sister-title">
                AML Logistics <span className="footer__sister-pvt">(Pvt) Ltd</span>
              </h5>
              <p className="footer__sister-desc">
                Our logistics arm provides complete nationwide fleet, safe warehousing, customs clearance, and commercial transport forwarding solutions since 1994.
              </p>
              <a 
                href="https://amllogistics.com/" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="footer__sister-btn"
              >
                Visit Website
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" width="11" height="11" style={{ marginLeft: "4px" }}>
            ...
            <ul className="footer__contact-list">
              {CONTACT.map((c, i) => (
                <li key={i} className="footer__contact-item">
                  ...
                  {c.href ? (
                    <a href={c.href} target={c.target} rel={c.rel} className="footer__contact-link">
                      {c.text}
                    </a>
                  ) : (
                    <span>{c.text}</span>
      ...
      <style jsx>{`
        ...
        .footer__grid {
          display: grid;
          grid-template-columns: 2.2fr 2.4fr 1.1fr 1.8fr 2.7fr;
          gap: 48px;
        }
